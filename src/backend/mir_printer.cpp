...
std::string_view opcodeName(MOpcode opcode) {
    ...
    case MOpcode::MUL:return "MUL"; case MOpcode::MULH:return "MULH";
    case MOpcode::DIV:return "DIV"; case MOpcode::REM:return "REM";
    case MOpcode::SLLI:return "SLLI"; case MOpcode::SRAI:return "SRAI";
    case MOpcode::SRLI:return "SRLI";
